...
describe('AuthService', () => {
    ...
    describe('login', () => {
        it('should call axios.post with the correct parameters', async () => {
            ...
            // Assert
            expect(axios.post).toHaveBeenCalledWith(expect.stringContaining('/auth/signin'), { username, password });
    ...
    describe('register', () => {
        ...
        it('should handle registration error', async () => {
            ...
            // Act & Assert
            await expect(AuthService.register(username, email, password)).rejects.toThrow('Username is already taken');
        });
    });
